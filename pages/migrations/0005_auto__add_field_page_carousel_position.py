...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.carousel_position'
        db.add_column(u'pages_page', 'carousel_position',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.carousel_position'
        db.delete_column(u'pages_page', 'carousel_position')
