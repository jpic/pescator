...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.footer_order'
        db.add_column(u'pages_page', 'footer_order',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Page.menu_order'
        db.alter_column(u'pages_page', 'menu_order', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Page.footer_order'
        db.delete_column(u'pages_page', 'footer_order')


        # Changing field 'Page.menu_order'
        db.alter_column(u'pages_page', 'menu_order', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        u'pages.page': {
            'Meta': {'ordering': "(u'menu_order', u'name')", 'object_name': 'Page'},
            ...
            'footer_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'menu_order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'name_fr': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
