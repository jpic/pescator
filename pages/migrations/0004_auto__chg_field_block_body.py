...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Block.body'
        db.alter_column(u'pages_block', 'body', self.gf('redactor.fields.RedactorField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Block.body'
        raise RuntimeError("Cannot reverse this migration. 'Block.body' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Block.body'
        db.alter_column(u'pages_block', 'body', self.gf('redactor.fields.RedactorField')())
