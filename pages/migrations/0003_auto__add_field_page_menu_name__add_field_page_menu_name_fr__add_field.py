...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'pages_page', 'menu_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.menu_name_fr'
        db.add_column(u'pages_page', 'menu_name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.menu_name_en'
        db.add_column(u'pages_page', 'menu_name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'pages_page', 'menu_name')

        # Deleting field 'Page.menu_name_fr'
        db.delete_column(u'pages_page', 'menu_name_fr')

        # Deleting field 'Page.menu_name_en'
        db.delete_column(u'pages_page', 'menu_name_en')
